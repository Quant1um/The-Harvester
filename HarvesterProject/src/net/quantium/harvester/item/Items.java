...
public class Items {
	 ...
	 public static byte leadPickaxe;
	 ...
	 public static byte leadPickaxeFragment;
	 ...
	 public static byte leadSpadeFragment;
	 ...
	 public static byte leadDaggerFragment;
	 ...
	 public static byte leadAxeFragment;
	 public static byte redAxeFragment;
	 
	 public static void register(){
		 workbench = Item.Registry.register(new BuildableItem("workbench", BuildableType.WORKBENCH));
		 chest = Item.Registry.register(new BuildableItem("chest", BuildableType.CHEST));
		 alloyFurnace = Item.Registry.register(new BuildableItem("furnace", BuildableType.FURNACE));
		 anvil = Item.Registry.register(new BuildableItem("anvil", BuildableType.ANVIL));
		 ...
		 oreLead = Item.Registry.register(new AbstractItem("leadore", 5, 6, 40, 1));
		 ...
		 lead = Item.Registry.register(new AbstractItem("lead", 9, 6, 20, 3));
		 ...
		 leadPickaxe = Item.Registry.register(new ToolItem("leadpickaxe", 1, 3, 4, ToolType.PICKAXE, 280, 3));
		 ...
		 leadAxe = Item.Registry.register(new ToolItem("leadaxe", 0, 7, 4, ToolType.AXE, 280, 3));
		 ...
		 leadSpade = Item.Registry.register(new ToolItem("leadspade", 0, 3, 4, ToolType.SHOVEL, 280, 3));
		 ...
		 leadDagger = Item.Registry.register(new ToolItem("leaddagger", 2, 7, 10, ToolType.DAGGER, 280, 3));
		 ...
		 leadPickaxeFragment = Item.Registry.register(new AbstractItem("leadpickaxefragment", 21, 3, 1, 4));
		 ...
		 leadAxeFragment = Item.Registry.register(new AbstractItem("leadaxefragment", 20, 7, 1, 4));
		 ...
		 leadSpadeFragment = Item.Registry.register(new AbstractItem("leadspadefragment", 20, 3, 1, 4));
		 ...
		 leadDaggerFragment = Item.Registry.register(new AbstractItem("leaddaggerfragment", 22, 7, 1, 10));
