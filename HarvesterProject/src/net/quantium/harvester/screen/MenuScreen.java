...
public abstract class MenuScreen extends AbstractContainerScreen { 
	...
	public static final int BUTTON_CENTER_X = (Main.instance().getRenderWidth() - BUTTON_SIZE * Layer.BLOCK_SIZE) / 2;
	...
	public void render(Renderer render) {
		render.get().fill(111);
		render.get().drawText(5, Main.instance().getRenderHeight() - 9, FontSize.SMALL, ALPHA_TEXT, 666, TextAlign.LEFT);
		render.get().drawText(Main.instance().getRenderWidth() - 5, Main.instance().getRenderHeight() - 9, FontSize.SMALL, AUTHOR_TEXT, 666, TextAlign.RIGHT);
